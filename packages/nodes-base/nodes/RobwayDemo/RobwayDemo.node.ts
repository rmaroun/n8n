...
export class RobwayDemo implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Robway (demo)',
		name: 'robwaydemo',
		icon: 'file:robwayDemo.svg',
		group: ['input'],
		version: 1,
		description: 'Read, update, write and delete data from Robway (demo)',
		defaults: {
			name: 'Robway (demo)',
		},
		inputs: ['main'],
		...
		properties: [
			...
			// ----------------------------------
			{
				...
				default: true,
				description: 'If all fields should be sent to Robway or only specific ones.',
			},
			{
				displayName: 'Fields',
				name: 'fields',
				...
				placeholder: 'Name',
				required: true,
				description: 'The name of fields for which data should be sent to Robway.',
			},
			...
			// ----------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: false,
						description: 'If the Robway API should attempt mapping of string values for linked records & select options.',
					},
				],
			},
		],
