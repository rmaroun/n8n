...
export class RobwayDemoTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Robway Trigger (demo)',
		name: 'robwayDemoTrigger',
		icon: 'file:robwayDemo.svg',
		group: ['trigger'],
		version: 1,
		description: 'Starts the workflow when Robway events occur',
		subtitle: '={{$parameter["event"]}}',
		defaults: {
			name: 'Robway Trigger (demo)',
		},
		credentials: [
			{
				name: 'robwayDemoApi',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: `Formulas may involve functions, numeric operations, logical operations, and text operations that operate on fields. More info <a href="https://support.robwaydemo.com/hc/en-us/articles/203255215-Formula-Field-Reference">here</a>.`,
					},
					{
						displayName: 'View ID',
						name: 'viewId',
