...
export class EnablonOrmDemoTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Enablon ORM Trigger (demo)',
		name: 'enablonOrmDemoTrigger',
		icon: 'file:enablonormdemo.png',
		group: ['trigger'],
		version: 1,
		description: 'Starts the workflow when Enablon ORM events occur',
		subtitle: '={{$parameter["event"]}}',
		defaults: {
			name: 'Enablon ORM Trigger (demo)',
		},
		credentials: [
			{
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: `Formulas may involve functions, numeric operations, logical operations, and text operations that operate on fields. More info <a href="https://support.enablonorm.com/hc/en-us/articles/203255215-Formula-Field-Reference">here</a>.`,
					},
					{
						displayName: 'View ID',
						name: 'viewId',
