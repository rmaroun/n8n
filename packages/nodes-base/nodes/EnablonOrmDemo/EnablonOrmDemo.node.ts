...
export class EnablonOrmDemo implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Enablon ORM (demo)',
		name: 'enablonormdemo',
		icon: 'file:enablonormdemo.png',
		group: ['input'],
		version: 1,
		description: 'Read, update, write and delete data from Enablon ORM (demo)',
		defaults: {
			name: 'Enablon ORM (demo)',
		},
		inputs: ['main'],
		outputs: ['main'],
		credentials: [
		...
		properties: [
			...
			// ----------------------------------
			{
				...
				default: true,
				description: 'If all fields should be sent to Enablon ORM or only specific ones.',
			},
			{
				displayName: 'Fields',
				name: 'fields',
				...
				placeholder: 'Name',
				required: true,
				description: 'The name of fields for which data should be sent to Enablon ORM.',
			},
			...
			// ----------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: false,
						description: 'If the Enablon ORM API should attempt mapping of string values for linked records & select options.',
					},
				],
			},
		],
